...
\title{Formatting Instructions for BITS F464 \\Project Submissions}
...
Reports to be submitted to BITS F464 Project must be prepared according to the instructions presented here.

\subsection{Retrieval of style files}

The file \verb+instructions.pdf+ contains these
instructions and illustrates the
various formatting requirements your report must satisfy.
...
have to do is replace the title, abstract, and text of the paper with
your own.
...
Download your report as PDF from overleaf
